...
4. Start the server:
   ...
   uv run python -m dark_app_factory.server

   # HTTP mode (for web dashboard)
   uv run uvicorn dark_app_factory.server:app --port 10739
   ```
5. Open `http://localhost:10739` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/dark-app-factory/issues) |
