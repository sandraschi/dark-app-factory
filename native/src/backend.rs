...
const BACKEND_NAME: &str = "dark-app-factory-backend.exe";
const BACKEND_PORT: u16 = 10738;
const BACKEND_TAG: &str = "dark-app-factory-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "DARK_APP_FACTORY_PORT";
const ENV_HOST: &str = "DARK_APP_FACTORY_HOST";
const ENV_TAURI: &str = "DARK_APP_FACTORY_TAURI";
...
pub fn spawn_backend(app: AppHandle, state: &BackendProcess) -> Result<String, String> {
    ...
    log_line(
        &app,
        &format!("spawning {} (cwd {}) on port 10738",
    ...
    Ok(format!("Backend starting on port 10738"))
}
